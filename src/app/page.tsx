        ...
        <main className='flex flex-col flex-1 bg-gradient-to-t  from-zinc-900 from-40% via-zinc-900 via-60%  to-green-500/50  to-100% rounded-xl px-5'>
          ...
          <div className='flex flex-col md:flex-row bg-black/20 py-12 gap-3 md:space-x-5 space-y-3 items-center px-5 mx-auto'>
            ...
            <div className='flex flex-col mx-0 gap-5'>
              ...
              <span className='font-medium'>Listen to the most sucessful Metal songs!Listen to the most sucessful Metal songs!Listen to the most sucessful Metal songs!Listen to the most sucessful Metal songs!Listen to the most sucessful Metal songs!Listen to the most sucessful Metal songs!</span>
      ...
      <footer className='h-16 px-3 py-5 md:py-10 flex md:items-center justify-between'>
        ...
        <div className='hidden md:flex flex-col md:w-2/6 items-center gap-3'>
          <div className='flex space-x-3 md:space-x-6 items-center'>
            <a href="#" className='text-zinc-400 hover:text-zinc-50 hidden md:flex'><span className="material-symbols-outlined scale-75 md:scale-105">shuffle</span></a>
            <a href="#" className='text-zinc-400 hover:text-zinc-50 hidden md:flex'><span className="material-symbols-outlined scale-75 md:scale-105">skip_previous</span></a>
            <a href="#" className='text-zinc-950 bg-zinc-50 hidden md:flex items-center rounded-full md:p-0.5 hover:ring ring-2 transition-all ring-zinc-50 '><span className="material-symbols-outlined scale-75 md:scale-105">play_arrow</span></a>
            <a href="#" className='text-zinc-400 hover:text-zinc-50 hidden md:flex'><span className="material-symbols-outlined scale-75 md:scale-105">skip_next</span></a>
            <a href="#" className='text-zinc-400 hover:text-zinc-50 hidden md:flex'><span className="material-symbols-outlined scale-75 md:scale-105">repeat</span></a>
          </div>
        ...
        <div className='hidden md:flex space-x-3 items-center'>
          ...
          <a href="#" className='text-zinc-400 hover:text-zinc-50 hidden md:flex'><span className="material-symbols-outlined scale-75">devices</span></a>
          <div className='flex items-center gap-2'>
            <a href="#" className='text-zinc-400 hover:text-zinc-50 hidden md:flex'><span className="material-symbols-outlined scale-75">volume_up</span></a>
