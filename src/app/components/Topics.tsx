...
export default function Topics() {
  return (
    <section className="grid grid-cols-1 pt-6 gap-3 md:grid-cols-2 lg:grid-cols-3">
      <div className="flex rounded-md overflow-hidden items-center space-x-4 bg-zinc-900 hover:bg-zinc-800 transition-colors cursor-pointer">
      ...
      {AlbumImages.slice(0, 5).map(function (item, index) {
        return (
          <div
            className="flex rounded-md overflow-hidden items-center space-x-4 bg-zinc-900 hover:bg-zinc-800 transition-colors cursor-pointer"
            key={index}
          >
